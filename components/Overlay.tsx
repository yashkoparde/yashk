  ...
  const otherProjects = [
    {
      ...
      github: "https://github.com/yashkoparde/Jobbridge",
    ...
    },
    {
      ...
      github: "https://github.com/yashkoparde/yogyatav0",
      badge: "EdTech Portal"
    },
    {
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex items-center gap-3 z-20">
                {p.github && (
                  <a href={p.github} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors duration-300 pointer-events-auto" title="Source Code">
                ...
                <a href={p.link} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors duration-300 pointer-events-auto" title="Live Demo">
    ...
    <div className="absolute inset-0 z-[200] pointer-events-none">
      ...
      <Section scrollYProgress={scrollYProgress} start={0.37} end={0.44} align="left">
        <ProjectBox 
          ...
          github="https://github.com/yashkoparde/wheyo"
          badge="Live SaaS"
        />
      </Section>
      ...
      <Section scrollYProgress={scrollYProgress} start={0.46} end={0.53} align="right">
        <ProjectBox 
          ...
          link="https://parakh-faraway.vercel.app/" 
          github="https://github.com/yashkoparde/Parakh-Ecosystem"
          badge="EdTech / AI"
        />
      </Section>
      ...
      <Section scrollYProgress={scrollYProgress} start={0.55} end={0.62} align="left">
        <ProjectBox 
          ...
          github="https://github.com/yashkoparde/evidentiaa"
          badge="Security / ML"
        />
      </Section>
      ...
      <Section scrollYProgress={scrollYProgress} start={0.64} end={0.71} align="right">
        <ProjectBox 
          ...
          link="https://pharmixlabs.vercel.app/" 
          github="https://github.com/yashkoparde/pharmix"
